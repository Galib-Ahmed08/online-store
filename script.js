...
function addToCart(productName, price) {
    const product = {
        name: productName,
        price: price,
        id: Date.now() // Simple unique ID for each cart item
    };
    cart.push(product);
...
// Initial count update on page load (for products.html)
document.addEventListener('DOMContentLoaded', updateCartCount);

// Function for contact.html button (your existing function)
// It uses an inline onclick in the HTML, but this is a reminder
// of where it would be if it were in script.js:
// function sayHi() {
